#################################################################################
# TITLE: Figures_Arbitraryk.R
#
# PURPOSE: Create figures for all relaxed MEM simulations. 
#
# OUTPUT: all arbitrary k figures as .jpeg files
#
...
library(tidyverse)
library(readr)
allresults <- read_csv("arbitraryk_results.csv")
...
modelsub <- c("relaxedMEM_twosource",
              "relaxedMEM_max",
              "relaxedMEM_stretch1","relaxedMEM_allornothing")
...
# #test
# jpeg("Arbitraryk_Figures/test1.jpeg", width = 1600, height = 800, quality = 100)
